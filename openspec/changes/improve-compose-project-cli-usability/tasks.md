...
- [ ] 4.4 Retain `_migrate_v14_environment_foreign_keys()` as the single current repair, adjust it only if the behavioral tests reveal a preservation/index/transaction defect, and do not advance schema version solely for this issue.
