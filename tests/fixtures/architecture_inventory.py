...
DIRECT_SUBPROCESS_LAUNCHES: Final[frozenset[SourceLocation]] = frozenset(
    {
        ...
        ("src/odoo_instance_sdk/resources/environment.py", 1241),
        ("src/odoo_instance_sdk/resources/environment.py", 1268),
        ("src/odoo_instance_sdk/resources/environment.py", 1300),
...
DIRECT_OUTPUT_WRITES: Final[frozenset[SourceLocation]] = frozenset(
    {
        ...
        ("src/odoo_instance_sdk/commands/env.py", 342),
...
OUTPUT_WRITE_REASONS: Final[dict[SourceLocation, str]] = {
    ...
    ("src/odoo_instance_sdk/commands/env.py", 342): "existing Rich live inventory transport",
...
EXPLICIT_IMPRECISE_ANNOTATIONS: Final[dict[str, frozenset[int]]] = {
    ...
    "src/odoo_instance_sdk/commands/env.py": frozenset({540, 544, 548, 552, 721, 734, 746}),
...
PUBLIC_PROCESS_METHODS: Final[dict[str, int]] = {
    ...
    "resources/environment.py:EnvironmentResource.refresh_database": 406,
    "resources/environment.py:EnvironmentResource.plan_checkout": 720,
    "resources/environment.py:EnvironmentResource.checkout_command": 731,
    "resources/environment.py:EnvironmentResource.checkout_with_plan": 744,
    "resources/environment.py:EnvironmentResource.checkout": 761,
    "resources/environment.py:EnvironmentResource.sync_python": 1170,
    "resources/environment.py:EnvironmentResource.open_pgadmin": 1319,
    "resources/environment.py:EnvironmentResource.remove": 1443,
