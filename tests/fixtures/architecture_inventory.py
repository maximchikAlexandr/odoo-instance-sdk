...
DIRECT_OUTPUT_WRITES: Final[frozenset[SourceLocation]] = frozenset(
    {
        ...
        ("src/odoo_instance_sdk/commands/output.py", 296),
        ("src/odoo_instance_sdk/commands/output.py", 298),
...
OUTPUT_WRITE_REASONS: Final[dict[SourceLocation, str]] = {
    ...
    ("src/odoo_instance_sdk/commands/output.py", 287): "shared JSON output boundary",
    ("src/odoo_instance_sdk/commands/output.py", 289): "shared TOON output boundary",
    ("src/odoo_instance_sdk/commands/output.py", 296): "shared diagnostic boundary",
    ("src/odoo_instance_sdk/commands/output.py", 298): "shared diagnostic boundary",
