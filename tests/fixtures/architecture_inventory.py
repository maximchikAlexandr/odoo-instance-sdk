...
DIRECT_SUBPROCESS_LAUNCHES: Final[frozenset[SourceLocation]] = frozenset(
    {
        ...
        ("src/odoo_instance_sdk/resources/environment.py", 1092),
        ("src/odoo_instance_sdk/resources/environment.py", 1119),
        ("src/odoo_instance_sdk/resources/environment.py", 1151),
...
PUBLIC_PROCESS_METHODS: Final[dict[str, int]] = {
    ...
    "resources/environment.py:EnvironmentResource.refresh_database": 355,
    "resources/environment.py:EnvironmentResource.plan_checkout": 609,
    "resources/environment.py:EnvironmentResource.checkout_command": 619,
    "resources/environment.py:EnvironmentResource.checkout_with_plan": 631,
    "resources/environment.py:EnvironmentResource.checkout": 646,
    "resources/environment.py:EnvironmentResource.sync_python": 1021,
    "resources/environment.py:EnvironmentResource.open_pgadmin": 1170,
    "resources/environment.py:EnvironmentResource.remove": 1294,
