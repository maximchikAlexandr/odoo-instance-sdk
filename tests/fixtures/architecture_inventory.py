...
DIRECT_SUBPROCESS_LAUNCHES: Final[frozenset[SourceLocation]] = frozenset(
    {
        ...
        ("src/odoo_instance_sdk/resources/environment.py", 1217),
        ("src/odoo_instance_sdk/resources/environment.py", 1244),
        ("src/odoo_instance_sdk/resources/environment.py", 1276),
...
PUBLIC_PROCESS_METHODS: Final[dict[str, int]] = {
    ...
    "resources/environment.py:EnvironmentResource.refresh_database": 391,
    "resources/environment.py:EnvironmentResource.plan_checkout": 702,
    "resources/environment.py:EnvironmentResource.checkout_command": 712,
    "resources/environment.py:EnvironmentResource.checkout_with_plan": 724,
    "resources/environment.py:EnvironmentResource.checkout": 739,
    "resources/environment.py:EnvironmentResource.sync_python": 1146,
    "resources/environment.py:EnvironmentResource.open_pgadmin": 1295,
    "resources/environment.py:EnvironmentResource.remove": 1419,
